...
export function Sidebar() {
  ...
  return (
    ...
    <ProtectedRoute>
      ...
      <aside
        className={cn(
          "w-[290px] max-w-[290px] overflow-hidden border-r border-gray-200 bg-white transition-transform duration-200 ease-linear dark:border-gray-800 dark:bg-gray-dark",
